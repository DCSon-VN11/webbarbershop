                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="tile">
                                ...
                                <h3 class="tile-title">Tạo Cửa hàng mới</h3>
                                <div class="tile-body">
                                    ...
                                    <form class="row" method="post" enctype="multipart/form-data">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input class="form-control" type="text" name="id" required placeholder="Ví dụ: Hà Nội">
                                        </div>
                                        <div class="form-group col-md-8">
                                            <label class="control-label">Địa chỉ thường trú</label>
                                            <input class="form-control" type="text" name="diachi" required placeholder="Ví dụ: Hà Nội">
                                        </div>
                                        <div class="form-group col-md-8">
                                            <label class="control-label">Địa chỉ Map</label>
                                            <textarea class="form-control" type="text" name="map" id="map" placeholder="Coppy src trong link nhúng trên GoogleMap"></textarea>
                                        </div>
                                </div>
                                <button name="btn" class="btn btn-primary">Lưu lại</button>
                                <a class="btn btn-primary" href="../cuahang.php">Hủy bỏ</a>
                                <?php
                                $get = new data();
                                if (isset($_POST['btn'])) {
                                    $in = $get->in_ch(
