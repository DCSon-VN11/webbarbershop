                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-muted font-20"> Đăng xuất Thành công. </p>
                            </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p class="text-muted">Quay lại <a href="login.php" class="text-muted ml-1"><b
                                        class="font-weight-semibold">Sign In</b></a></p>
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
